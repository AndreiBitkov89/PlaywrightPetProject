...
export class PageWithItemsLocators {
    ...
    constructor(public readonly page: Page) {
        ...
        this.emptyListMessage = page.locator('.EmptyListingFallback__textWrapper h2');
    ...
    cardByName = (name: string) =>
        this.page.locator("div[data-testid^='product-card-'] [data-testid='product-name']", { hasText: name }).first();
