...
export class RegistrationLocators {
    ...
    constructor(public readonly page: Page) {
        ...
        this.checkBoxStore = page.locator("input[name^='marketingInterest-klaviyo=");
        this.submitButton = page.locator("//*[text()='Create an account']");

        this.errorName = page.locator('*[data-testid="input-message-given_name"]');
        this.errorSurname = page.locator('*[data-testid="input-message-family_name"]');
        ...
        this.errorConfirmPassword = page.locator('*[data-testid="input-message-confirmPassword"]');
    }
}
